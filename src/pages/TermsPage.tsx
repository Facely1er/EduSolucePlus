          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg border p-8 space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                By accessing or using EduSoluce™ ("Service"), you agree to be bound by these Terms of Service ("Terms"). 
                If you disagree with any part of these terms, then you may not access the Service.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                EduSoluce™ is provided by ERMITS LLC, a cybersecurity and educational compliance company dedicated to 
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                EduSoluce™ is an educational platform that provides:
              </p>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  The Service and its original content, features, and functionality are owned by ERMITS LLC and are 
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                To the maximum extent permitted by applicable law, ERMITS LLC shall not be liable for any indirect, 
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center">
                    ...
                    <span>Email: support@ermits.com</span>
                  </div>
                  <div className="flex items-center">
                    <FileText className="h-4 w-4 mr-2 text-primary-600" />
                    <span>Address: 8300 McCullough Lane, Suite 203, Gaithersburg, MD 20877</span>
                  </div>
                </div>
              </div>
            </section>
