...
import { ChevronDown, ChevronUp, Search, ArrowLeft, HelpCircle, MessageSquare, Shield, Lock, Laptop, Mail } from 'lucide-react';
...
export function FAQPage() {
  ...
  const faqData: FAQItem[] = [
    // General questions
    {
      id: 'what-is-edusoluce',
      question: 'What is EduSoluce™?',
      answer: (
        <>
          <p>
            EduSoluce™ is a comprehensive educational compliance platform designed to help schools and educational
    ...
    {
      id: 'who-should-use',
      question: 'Who should use EduSoluce™?',
      answer: (
        <>
          <p>EduSoluce™ is designed for all stakeholders in educational institutions, including:</p>
          <ul className="list-disc ml-6 mt-2 space-y-1">
    ...
    {
      id: 'cost',
      question: 'How much does EduSoluce™ cost?',
      answer: (
        <>
          <p>
            EduSoluce™ offers flexible pricing models designed to accommodate educational institutions of all sizes:
          </p>
          <ul className="list-disc ml-6 mt-2 space-y-1">
    ...
    // Account questions
    {
      ...
      answer: (
        <>
          <p>Creating an account with EduSoluce™ is simple:</p>
    ...
    {
      id: 'data-protection',
      question: 'How does EduSoluce™ protect my data?',
      answer: (
        <>
          <p>EduSoluce™ implements robust data protection measures in line with educational privacy requirements:</p>
          <ul className="list-disc ml-6 mt-2 space-y-1">
          ...
          <p className="mt-2">
            For more detailed information, please review our <Link to="/privacy-policy" className="text-primary-600 hover:underline">Privacy Policy</Link>.
          </p>
        </>
      ),
      category: 'privacy'
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <p className="mt-2">
            Alternatively, you can contact our privacy team directly at <a href="mailto:privacy@edusoluce.com" className="text-primary-600 hover:underline">privacy@edusoluce.com</a>. For organizational accounts, an administrator must submit the data deletion request.
          </p>
          <p className="mt-2">
    ...
    // Technical questions
    {
      ...
      answer: (
        <>
          <p>EduSoluce™ supports the following browsers:</p>
          <ul className="list-disc ml-6 mt-2 space-y-1">
    ...
    {
      id: 'offline-access',
      question: 'Can I use EduSoluce™ offline?',
      answer: (
        <p>
    ...
    // Compliance questions
    {
      ...
      question: 'Are EduSoluce™ certificates recognized for compliance purposes?',
      answer: (
        <>
          <p>
            EduSoluce™ certificates demonstrate completion of privacy training and assessments, which can be valuable documentation for your institution's compliance efforts. While our certificates are not government-issued credentials, they provide evidence of:
          </p>
          <ul className="list-disc ml-6 mt-2 space-y-1">
    ...
    {
      id: 'compliance-audit',
      question: 'Can EduSoluce™ help with compliance audits?',
      answer: (
        <>
          <p>Yes, EduSoluce™ provides several features that support compliance audits:</p>
          <ul className="list-disc ml-6 mt-2 space-y-1">
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-muted-foreground">
              Find answers to common questions about EduSoluce™ and educational privacy compliance
            </p>
          </div>
          <Link to="/contact">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mt-6 pt-4 border-t">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              <Link to="/how-it-works" title="Learn how EduSoluce works">
