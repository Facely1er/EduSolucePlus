...
import { Search, ChevronLeft, ChevronRight, BookOpen, GraduationCap, Target } from 'lucide-react';
...
export function StudentAssessmentPage() {
  ...
  const filteredAssessments = (studentAssessments || []).filter(assessment => {
    ...
    <div className="container py-8">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">
          Évaluations Étudiant(e)
        </h1>
        <p className="text-muted-foreground">
          Complétez ces évaluations pour apprendre sur vos droits et la protection de vos données ({filteredAssessments.length} évaluations)
        </p>
      </div>
      ...
      <div className="mt-8 p-6 bg-gray-50 dark:bg-gray-950 rounded-lg border">
        <h2 className="text-xl font-semibold mb-4">Empower Your Digital Privacy Journey</h2>
        <p className="text-muted-foreground mb-4">
          Ready to learn more about your privacy rights and how to stay safe online? Explore our professional guides and engaging learning paths designed for students.
        </p>
        <div className="flex flex-wrap gap-3">
          <Link to="/resources/professional-guides" title="Access student-friendly privacy guides">
            <Button variant="outline">
              <BookOpen className="mr-2 h-4 w-4" /> 
              Privacy learning guides
            </Button>
          </Link>
          <Link to="/learning-paths" title="Explore structured learning paths for students">
            <Button variant="outline">
              <GraduationCap className="mr-2 h-4 w-4" /> 
              Learning paths
            </Button>
          </Link>
          <Link to="/training" title="Access interactive privacy training modules">
            <Button variant="outline">
