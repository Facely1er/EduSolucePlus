...
import { Search, ChevronLeft, ChevronRight, BookOpen, GraduationCap, Shield } from 'lucide-react';
...
export function ITStaffAssessmentPage() {
  ...
  const filteredAssessments = (itStaffAssessments || []).filter(assessment => {
    ...
    <div className="container py-8">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">
          Évaluations Personnel IT / DSI
        </h1>
        <p className="text-muted-foreground">
          Complétez ces évaluations pour évaluer et améliorer vos connaissances techniques en sécurité ({filteredAssessments.length} évaluations)
        </p>
      </div>
      ...
      <div className="mt-8 p-6 bg-gray-50 dark:bg-gray-950 rounded-lg border">
        <h2 className="text-xl font-semibold mb-4">Strengthen Your Technical Security Expertise</h2>
        <p className="text-muted-foreground mb-4">
          Looking to enhance your skills in educational cybersecurity and data protection? Dive into our professional guides and comprehensive learning paths designed for IT staff.
        </p>
        <div className="flex flex-wrap gap-3">
          <Link to="/resources/professional-guides" title="Access IT staff-specific security training guides">
            <Button variant="outline">
              <BookOpen className="mr-2 h-4 w-4" /> 
              Professional development guides
            </Button>
          </Link>
          <Link to="/learning-paths" title="Explore structured learning paths for IT staff">
            <Button variant="outline">
              <GraduationCap className="mr-2 h-4 w-4" /> 
              Learning paths
            </Button>
          </Link>
          <Link to="/privacy/vendors" title="Learn about vendor security assessments">
            <Button variant="outline">
