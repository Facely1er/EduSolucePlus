...
import { Search, ChevronLeft, ChevronRight, BookOpen, GraduationCap, Users } from 'lucide-react';
  ...
  return (
    <div className="container py-8">
      ...
      <div className="mt-8 p-6 bg-gray-50 dark:bg-gray-950 rounded-lg border">
        <h2 className="text-xl font-semibold mb-4">Enhance Your Classroom Privacy Skills</h2>
        <p className="text-muted-foreground mb-4">
          Ready to deepen your understanding of student data protection and classroom privacy best practices? Explore our professional guides and comprehensive learning paths tailored for teachers.
        </p>
        <div className="flex flex-wrap gap-3">
          <Link to="/resources/professional-guides" title="Access teacher-specific privacy training guides">
            <Button variant="outline">
              <BookOpen className="mr-2 h-4 w-4" /> 
              Professional development guides
            </Button>
          </Link>
          <Link to="/learning-paths" title="Explore structured learning paths for teachers">
            <Button variant="outline">
              <GraduationCap className="mr-2 h-4 w-4" /> 
              Learning paths
            </Button>
          </Link>
          <Link to="/privacy/consent" title="Learn about managing student consent">
            <Button variant="outline">
