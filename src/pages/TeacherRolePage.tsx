...
export function TeacherRolePage() {
  ...
  if (import.meta.env.DEV) {
    console.log('TeacherRolePage - render', { 
    ...
    return (
      <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
        ...
        <p className="text-blue-700 dark:text-blue-300 mb-3">
          You're viewing the Teacher Hub in demo mode. Some features may be limited without authentication.
        </p>
  ...
  // Role suggestion notice if user is not a teacher
  const RoleSuggestionNotice = () => {
    if (!user || isTeacher) return null;
    
    return (
      <div className="mb-4 p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg">
        <h3 className="font-medium text-amber-800 dark:text-amber-200 mb-1">Viewing Teacher Content</h3>
        <p className="text-amber-700 dark:text-amber-300 mb-3">
          You're viewing content for teachers, but your account is registered as a {profile?.role.replace('-', ' ')}. 
  ...
  return (
    <div className="container py-8">
      ...
      <div className="mb-8">
        <RoleDetailCard roleType="teacher" />
      </div>
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-6">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
          <p className="text-sm text-blue-800 dark:text-blue-300">
            <strong>Teacher Hub:</strong> Use the tabs above to switch between your classroom dashboard, privacy assessments, and training. The dashboard provides privacy insights for educators, assessments evaluate your knowledge, and the action plan guides your professional development in privacy practices.
          </p>
        </div>
        ...
        <TabsContent value="training" className="mt-0">
          <RoleTrainingContent roleType="teacher" />
        </TabsContent>
      </Tabs>
    </div>
  );
