  ...
  const dataRightsRequests = [
    {
      ...
      requesterName: 'Sarah Johnson (Parent)',
    ...
    },
    {
      ...
      requesterName: 'Michael Chen (Student)',
    ...
    {
      id: 'req-003',
      type: 'directory_opt_out',
      title: 'Directory Information Opt-Out',
      studentName: 'Alex Rodriguez',
      requesterName: 'Maria Rodriguez (Parent)',
