...
export function VendorAssessmentsPage() {
  ...
  // Mock vendor assessments data
  const vendorAssessments = [
    {
      id: 'vendor-001',
      vendorName: 'Google for Education',
      serviceDescription: 'Email, document collaboration, and classroom management tools',
      dataTypesProcessed: ['Student names', 'Email addresses', 'Academic work', 'Communication logs'],
      studentDataAccess: true,
      applicableRegulations: ['ferpa', 'coppa', 'ccpa'],
      assessmentScore: 88,
      riskLevel: 'low',
      ...
      securityCertifications: ['SOC 2 Type II', 'ISO 27001', 'FedRAMP'],
    ...
    },
    {
      ...
      serviceDescription: 'Online learning platform and educational content',
      dataTypesProcessed: ['Student names', 'Learning progress', 'Assessment results'],
      studentDataAccess: true,
    ...
    {
      id: 'vendor-003',
      vendorName: 'Zoom Education',
      serviceDescription: 'Video conferencing and online meeting platform',
      dataTypesProcessed: ['Student names', 'Video recordings', 'Chat messages', 'Email addresses'],
      studentDataAccess: true,
      applicableRegulations: ['ferpa', 'ccpa', 'bipa'],
      assessmentScore: 75,
      riskLevel: 'medium',
      contractStartDate: '2024-03-01',
      contractEndDate: '2025-02-28',
      lastAssessmentDate: '2024-10-10',
      nextAssessmentDue: '2025-10-10',
      complianceStatus: 'review_needed',
      securityCertifications: ['SOC 2 Type II', 'FedRAMP'],
      privacyPolicyReviewed: false,
      dpaSignificant: true
    },
    {
      id: 'vendor-004',
      vendorName: 'ClassDojo',
      serviceDescription: 'Classroom communication and behavioral tracking',
      dataTypesProcessed: ['Student names', 'Behavioral data', 'Photos', 'Parent communications'],
      studentDataAccess: true,
      applicableRegulations: ['ferpa', 'coppa'],
      assessmentScore: 70,
      riskLevel: 'medium',
      ...
      nextAssessmentDue: '2025-08-15',
      complianceStatus: 'review_needed',
      securityCertifications: ['SOC 2 Type I'],
      privacyPolicyReviewed: true,
      dpaSignificant: false
    },
    {
      id: 'vendor-005',
      vendorName: 'TechSupport Solutions',
      serviceDescription: 'IT support and system maintenance services',
      dataTypesProcessed: ['System logs', 'User credentials', 'Technical data'],
      studentDataAccess: false,
      applicableRegulations: ['shield'],
      assessmentScore: 65,
      riskLevel: 'high',
      contractStartDate: '2024-01-01',
      contractEndDate: '2025-12-31',
      lastAssessmentDate: '2024-06-01',
      nextAssessmentDue: '2025-06-01',
