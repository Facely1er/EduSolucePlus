  ...
  const consentRecords = [
    {
      ...
      parentGuardianEmail: 'sarah.johnson@email.com',
      consentType: 'directory_information',
      purpose: 'educational_services',
      serviceProvider: 'School Directory',
      consentGiven: false,
      consentDate: null,
      withdrawalDate: '2024-09-15',
      expiryDate: null,
    ...
    },
    {
      ...
      parentGuardianName: 'Lisa Chen',
      parentGuardianEmail: 'lisa.chen@email.com',
      consentType: 'edtech_usage',
      purpose: 'educational_services',
      serviceProvider: 'Google Classroom',
      consentGiven: true,
      consentDate: '2024-08-20',
      withdrawalDate: null,
    ...
    },
    {
      ...
      parentGuardianEmail: 'maria.rodriguez@email.com',
      consentType: 'photo_video_consent',
      purpose: 'communications',
      serviceProvider: 'School Communications',
      consentGiven: true,
      consentDate: '2024-09-01',
      withdrawalDate: null,
    ...
    },
    {
      ...
      parentGuardianName: 'David Thompson',
      parentGuardianEmail: 'david.thompson@email.com',
      consentType: 'biometric_data',
      purpose: 'administrative',
      serviceProvider: 'Lunch Payment System',
      consentGiven: true,
      consentDate: '2024-08-30',
      withdrawalDate: null,
      expiryDate: null,
      renewalRequired: false,
      applicableRegulations: ['bipa'],
      status: 'active'
    },
    {
      id: 'consent-005',
      ...
      parentGuardianName: 'Jennifer Kim',
      parentGuardianEmail: 'jennifer.kim@email.com',
      consentType: 'data_sharing',
      purpose: 'research',
      serviceProvider: 'Educational Research Partner',
      consentGiven: false,
      consentDate: null,
      withdrawalDate: null,
      expiryDate: null,
      renewalRequired: false,
      applicableRegulations: ['ferpa', 'ccpa'],
      status: 'pending'
    }
  ];
