...
const northAmericanRegulations = [
  { id: 'ferpa', name: 'FERPA', fullName: 'Family Educational Rights and Privacy Act' },
  { id: 'coppa', name: 'COPPA', fullName: 'Children\'s Online Privacy Protection Act' },
  { id: 'ccpa', name: 'CCPA', fullName: 'California Consumer Privacy Act' },
  { id: 'bipa', name: 'BIPA', fullName: 'Biometric Information Privacy Act' },
  { id: 'shield', name: 'SHIELD', fullName: 'Stop Hacks and Improve Electronic Data Security Act' }
];
...
export function ComplianceObligationsPage() {
  ...
  // Mock compliance obligations data
  const complianceObligations = [
    {
      id: 'obl-001',
      regulation: 'ferpa',
      title: 'Annual FERPA Notice Distribution',
      description: 'Distribute annual notification of FERPA rights to all parents and eligible students',
      frequency: 'annual',
      dueDate: '2025-08-15',
      ...
      evidenceRequired: ['Distribution records', 'Notice content', 'Translation documentation'],
      automationPossible: true,
      externalDependencies: ['Communications Department', 'Translation Services']
    },
    {
      id: 'obl-002',
      regulation: 'coppa',
      title: 'Quarterly Vendor COPPA Compliance Review',
      description: 'Review all educational technology vendors for COPPA compliance',
      frequency: 'quarterly',
      dueDate: '2025-03-31',
      nextDueDate: '2025-03-31',
      status: 'in_progress',
      priority: 'high',
      responsibleRole: 'it-staff',
      completionPercentage: 60,
      evidenceRequired: ['Vendor assessments', 'Privacy policy reviews', 'Consent documentation'],
      automationPossible: false,
      externalDependencies: ['EdTech Vendors', 'Legal Department']
    },
    {
      id: 'obl-003',
      regulation: 'ccpa',
      title: 'Consumer Privacy Rights Notice Update',
      description: 'Update privacy notice to include CCPA consumer rights for California residents',
      frequency: 'annual',
      dueDate: '2025-06-30',
      ...
      evidenceRequired: ['Updated privacy notice', 'Legal review', 'Publication records'],
      automationPossible: false,
      externalDependencies: ['Legal Counsel']
    },
    {
      id: 'obl-004',
      regulation: 'bipa',
      title: 'Biometric Data Consent Collection',
      description: 'Obtain written consent before collecting biometric data for time tracking',
      frequency: 'ongoing',
      dueDate: '2025-02-01',
      ...
      evidenceRequired: ['Consent forms', 'Biometric policy', 'Collection procedures'],
      automationPossible: true,
      externalDependencies: ['HR Department', 'Time Tracking Vendor']
    },
    {
      id: 'obl-005',
      regulation: 'shield',
      title: 'Annual Security Safeguards Review',
      description: 'Review and update data security measures under NY SHIELD Act',
      frequency: 'annual',
      dueDate: '2025-12-31',
      ...
      evidenceRequired: ['Security assessment', 'Policy updates', 'Training records'],
      automationPossible: true,
      externalDependencies: ['IT Security Team', 'External Auditors']
    }
  ];
