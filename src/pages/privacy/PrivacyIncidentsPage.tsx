...
export function PrivacyIncidentsPage() {
  ...
  const privacyIncidents = [
    {
      id: 'inc-2025-001',
      incidentNumber: 'PRI-2025-001',
      title: 'Unauthorized Email Access',
      type: 'unauthorized_access',
      severity: 'medium',
      description: 'Teacher account compromised, potential access to student email communications',
      affectedIndividualsCount: 150,
      dataTypesAffected: ['Email communications', 'Student names', 'Course information'],
      discoveryDate: '2025-01-03',
      incidentDate: '2025-01-01',
      containmentDate: '2025-01-03',
      status: 'in_progress',
      reportedToAuthorities: false,
      individualsNotified: false,
      assignedTo: 'IT Security Team',
      applicableRegulations: ['ferpa', 'shield']
    },
    {
      id: 'inc-2024-047',
      incidentNumber: 'PRI-2024-047',
      title: 'Student Records Misfiling',
      type: 'privacy_violation',
      severity: 'low',
      description: 'Physical student records were temporarily placed in wrong filing cabinet',
      affectedIndividualsCount: 5,
      dataTypesAffected: ['Academic records', 'Contact information'],
      discoveryDate: '2024-12-20',
      incidentDate: '2024-12-18',
      containmentDate: '2024-12-20',
      resolutionDate: '2024-12-21',
      status: 'resolved',
      reportedToAuthorities: false,
      individualsNotified: true,
      assignedTo: 'Records Office',
      applicableRegulations: ['ferpa']
    },
    {
      id: 'inc-2024-046',
      incidentNumber: 'PRI-2024-046',
      title: 'EdTech Vendor Data Exposure',
      type: 'data_breach',
      severity: 'high',
      description: 'Third-party education platform experienced data breach affecting student information',
      affectedIndividualsCount: 850,
      dataTypesAffected: ['Student names', 'Grade information', 'Assignment submissions'],
      discoveryDate: '2024-12-15',
      incidentDate: '2024-12-10',
      containmentDate: '2024-12-16',
      resolutionDate: '2024-12-30',
      status: 'resolved',
      reportedToAuthorities: true,
      notificationAuthorities: ['Department of Education', 'State Attorney General'],
      individualsNotified: true,
      assignedTo: 'Privacy Officer',
      applicableRegulations: ['ferpa', 'ccpa', 'coppa']
    }
  ];
